...
public class AlarmUnInformationActivity extends BaseActivity{
...
//    String pic_array_str = "";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alarmuninformation);
        context = this;
    ...
    private void initView() {
        ...
        line_video = (View) findViewById(R.id.line_video);
        ...
        commit_layout = (LinearLayout) this.findViewById(R.id.commit_layout);
...
//        mDisplayVoiceProgressBar = (ProgressBar) findViewById(R.id.voice_display_voice_progressbar);
        ...
        handle_bt = (Button) findViewById(R.id.handle_bt);
        handle_bt.setOnClickListener(this);
        invalid_bt = (Button) findViewById(R.id.invalid_bt);
        invalid_bt.setOnClickListener(this);
    ...
    public void GetVideo() {
        if(videoName.equals("")||videoName==null||videoName.startsWith("anyType")){
...
//        });
        ...
        mPlayState = false;
//        if(audioName.startsWith("anyType")){
            if(audioName.equals("")||audioName.startsWith("anyType")){
...
//                            mMediaPlayer.prepare();
                            String path_str = SOAP_UTILS.IP + "/manage/audio/" + audioName;
                            mMediaPlayer.setDataSource(path_str); 
                            mMediaPlayer.prepare();
                            // 播放
                            mMediaPlayer.start();
                            // 根据时间修改界面
...
//        location_edit.setText("11111111");
        location_edit.setClickable(true);
        location_edit.setOnClickListener(this);
        ...
        if(textContents.equals("")||textContents==null ||textContents.startsWith("anyType")){
...
//                line_text.setVisibility(8);
        ...
        if(textContents.equals("")&&imageUrls.size()==0){
              line_text.setVisibility(8);
              line_voice.setVisibility(8);
          }
        
        if(textContents.equals("")&&audioName.equals("") && imageUrls.size()==0){
...
//   
    ...
    public void onEvent(Object obj) {
        ...
        }else if(res.getCode().equals(SOAP_UTILS.METHOD.CHANGEDATASTATUS)){
            if (res.getObj().toString().equals("true")) {

                Toast.makeText(context, "已成功提交处理信息",Toast.LENGTH_SHORT).show();
              }else {

                  Toast.makeText(context, "提交处理信息失败",Toast.LENGTH_SHORT).show();
              }
              
            finish();
        }else if(res.getCode().equals(SOAP_UTILS.METHOD.CHANGEDATASTATUSINVALID)){
            if (res.getObj().toString().equals("true")) {

                Toast.makeText(context, "已成功提交无效报警信息",Toast.LENGTH_SHORT).show();
              }else {

                  Toast.makeText(context, "提交无效报警信息失败",Toast.LENGTH_SHORT).show();
              }
    ...
    public void onClick(View v) {
        ...
        case R.id.handle_bt:
            ...
            String[] property_va = new String[] {Id,"处理"};
            soapService.ChangeDataStatus(property_va);
            break;
        case R.id.invalid_bt:
            
            String[] property_vas = new String[] {Id,"无效报警"};
            soapService.ChangeDataStatusInvalid(property_vas);
            break;
        case R.id.location_edit:
            Intent intent2 = new Intent();
            intent2.putExtra("Id", Id);
            intent2.putExtra("coordinateX", longitude);
            intent2.putExtra("coordinateY", latitude);
            intent2.setClass(AlarmUnInformationActivity.this, MapActivity.class);
